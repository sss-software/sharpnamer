...
namespace SharpNamer
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(SharpNamerCodeRefactoringProvider)), Shared]
    internal class SharpNamerCodeRefactoringProvider : CodeRefactoringProvider
    {
